		...
		<header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-blue-800'>
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					<Link to='/' className='text-2xl font-bold text-WHITE-600 items-center space-x-2 flex'>
						CULTURE CLOSET
					</Link>
					 ...
					 ease-in-out'
						...
						{user && (
							...
							>
								...
								{cart.length > 0 && (
									<span
										className='absolute -top-2 -left-2 bg-blue-400 text-white rounded-full px-2 py-0.5 
